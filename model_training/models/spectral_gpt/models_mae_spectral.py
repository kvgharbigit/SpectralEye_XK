...
class EncoderVit(nn.Module):
    ...
    def forward(self, x, masking=False):
        ...
        assert L == self.num_img_patches[0] * self.num_img_patches[1], "Spatial patches should be equal to number of spatial patches"
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def forward(self, imgs):
        latent, mask, ids_restore = self.encoder(imgs, masking=True)
